...
import { CredencialesUsuarioDTO, RespuestaAutenticacionDTO, UsuariosDTO } from './seguridad';
...
export class SeguridadService {
  ...
  obtenerUsuariosPaginado(paginacion: PaginacionDTO): Observable<HttpResponse<UsuariosDTO[]>> {
    let queryParams = construirQueryParams(paginacion);
    return this.http.get<UsuariosDTO[]>(`${this.urlBase}/ListadoUsuarios`, {params: queryParams, observe: 'response'});
  }
