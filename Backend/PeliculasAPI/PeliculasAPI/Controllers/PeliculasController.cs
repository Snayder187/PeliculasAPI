...
namespace PeliculasAPI.Controllers
{
    ...
    public class PeliculasController: CustomBaseController
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Post([FromForm] PeliculaCreacionDTO peliculasCreacionDTO)
        {
            var pelicula = mapper.Map<Pelicula>(peliculasCreacionDTO);
            if (peliculasCreacionDTO.Poster is not null)
            {
                var url = await almacenadorArchivos.Almacenar(contenedor, peliculasCreacionDTO.Poster);
                pelicula.Poster = url;
            }
